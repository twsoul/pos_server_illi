...
<script>
	function goUpdate() {
		document.detailForm.action = "<c:url value='/cmm/aop/AopSampleRegister.do'/>";
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<!--  왼쪽 메뉴 시작 -->
			<c:set var="menuId" value="19" />
			<%@include file="../include/menu.jsp"%>
			<!--  왼쪽 메뉴 끝 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">AOP(Annotation) Message</h1>
				<form:form commandName="aopSampleVO" id="detailForm"
					name="detailForm" class="form-horizontal" role="form" >
					<div class="form-group">
						<label class="col-sm-1 control-label">입력<font
				...
				<div class="panel-group">
					<div class="panel-body" align="right">
						</a> <a href="javascript:goUpdate();" class="btn btn-success">실행
