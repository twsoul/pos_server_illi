 ...
 * </pre>
 *
 * @ClassName   : FileSampleMinController.java
 ...
 */
@Controller
public class FileSampleMinController extends HController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(path="/cmm/file/uploadMin.do", method = RequestMethod.POST)
	public String uploadMin(HttpServletRequest request) throws Exception {
		//파일 업로드
		...
		//목록 보여주기 redirect
		return "redirect:selectFileListMin.do";
	}
	 ...
	 * @throws IOException
	 */
	@RequestMapping(path="/cmm/file/downloadMin.do")
	public void downloadMin(HMap hMap, HttpServletRequest request, HttpServletResponse response) throws IOException{
	 ...
	 * @return
	 */
	@RequestMapping(path="/cmm/file/selectFileListMin.do")
	public String selectFileListMin(HMap hMap, ModelMap model){
		//DB 읽기
		List<FileVO> fvoList = fileSampleService.selectFileVOList(hMap);
		model.put("fileVOList", fvoList);
		return "able/file/fileSampleMin";
	}
	 ...
	 * @throws IOException
	 */
	@RequestMapping(path="/cmm/file/deleteMin.do")
	public String deleteMin(HMap hMap, ModelMap model) throws IOException{
		FileVO fvo = fileSampleService.selectFileVOByKey(hMap);
		String filePath = fvo.getFolderPath() + File.separator + fvo.getStoredFileName();
		//파일 삭제
