...
<script>
	function goUpdate() {
		document.detailForm.action = "<c:url value='/cmm/aopxml/AopSampleRegister.do'/>";
...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			<!--  왼쪽 메뉴 시작 -->
			<c:set var="menuId" value="20" />
			<%@include file="../include/menu.jsp"%>
			<!--  왼쪽 메뉴 끝 -->
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">AOP(XML) Message</h1>
				<form:form commandName="aopSampleXMLVO" id="detailForm"
